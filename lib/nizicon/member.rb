module Nizicon
  class Member
    attr_accessor :id, :name, :position, :nickname, :birthday, :hometown, :twitter_id, :blog_uri, :head_shot_uri, :introduction, :pixiv_id, :preparatory
    ...
    def attributes
      %i(
        ...
        twitter_id blog_uri head_shot_uri pixiv_id age preparatory
